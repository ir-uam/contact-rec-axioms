...
/**
 * Adaptation of the Query Likelihood Information Retrieval method, with Dirichlet regularization, and without
 * term discrimination.
 *
 ...
 */
public class QLDNoTermDiscrimination<U> extends UserFastRankingRecommender<U>
{
    /**
     ...
     */
    public QLDNoTermDiscrimination(FastGraph<U> graph, EdgeOrientation uSel, EdgeOrientation vSel, double mu)
    {
        super(graph);
